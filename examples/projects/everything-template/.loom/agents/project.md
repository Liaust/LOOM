# LOOM Everything Template Project Guidance

<!-- loom-managed: project-guidance/v1 -->

This project is identified by `.loom/project.yaml` as `everything-template` and is owned
...
- Enabled facets: `backup_policy, connectors, datasets, direct_events, docs, modules, notes, portal, repos, schedules, scripts, secrets, sync_policy, tests, worker_policy, workflows`
